...
import 'package:recipe_app/services/beef_recipes_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class BeefRecipesPage extends StatefulWidget {
  const BeefRecipesPage({super.key});

  @override
  State<BeefRecipesPage> createState() => _BeefRecipesPageState();
}

class _BeefRecipesPageState extends State<BeefRecipesPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<BeefRecipesModel>(
              future: getBeefRecipes(),
