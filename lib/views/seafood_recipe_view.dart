...
import 'package:recipe_app/services/seafood_recipe_view.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class SeafoodRecipeView extends StatefulWidget {
  const SeafoodRecipeView({super.key});

  @override
  State<SeafoodRecipeView> createState() => _SeafoodRecipeViewState();
}

class _SeafoodRecipeViewState extends State<SeafoodRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<SeafoodRecipeModel>(
              future: getSeafoodRecipes(),
