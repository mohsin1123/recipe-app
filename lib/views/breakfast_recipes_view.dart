...
import 'package:recipe_app/services/breakfast_Recipe_model.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class BreakfastRecipesView extends StatefulWidget {
  const BreakfastRecipesView({super.key});

  @override
  State<BreakfastRecipesView> createState() => _BreakfastRecipesViewState();
}

class _BreakfastRecipesViewState extends State<BreakfastRecipesView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<BreakfastRecipesModel>(
              future: getBreakfastRecipes(),
