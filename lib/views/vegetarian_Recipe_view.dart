...
import 'package:recipe_app/services/vegetarian_recipe_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class VegetarianRecipeView extends StatefulWidget {
  const VegetarianRecipeView({super.key});

  @override
  State<VegetarianRecipeView> createState() => _VegetarianRecipeViewState();
}

class _VegetarianRecipeViewState extends State<VegetarianRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<VegetarianRecipesModel>(
              future: getVegetarianRecipes(),
