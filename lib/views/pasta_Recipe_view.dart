...
import 'package:recipe_app/services/pasta_recipe_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class PastaRecipeView extends StatefulWidget {
  const PastaRecipeView({super.key});

  @override
  State<PastaRecipeView> createState() => _PastaRecipeViewState();
}

class _PastaRecipeViewState extends State<PastaRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<PastaModelRecipe>(
              future: getPastaRecipe(),
