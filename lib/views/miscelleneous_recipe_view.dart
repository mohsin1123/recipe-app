...
import 'package:recipe_app/services/miscelleneous_recipe_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class MiscelleneousRecipeView extends StatefulWidget {
  const MiscelleneousRecipeView({super.key});

  @override
  State<MiscelleneousRecipeView> createState() =>
      _MiscelleneousRecipeViewState();
}

class _MiscelleneousRecipeViewState extends State<MiscelleneousRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<MiscellaneousRecipeModel>(
              future: getMiscelleneousRecipes(),
