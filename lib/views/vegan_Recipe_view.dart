...
import 'package:recipe_app/services/vegan_recipes_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class VeganRecipeView extends StatefulWidget {
  const VeganRecipeView({super.key});

  @override
  State<VeganRecipeView> createState() => _VeganRecipeViewState();
}

class _VeganRecipeViewState extends State<VeganRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<VeganRecipesModel>(
              future: getVeganRecipes(),
