                                        ...
                                        builder: (context) => ChickenRecipeView(
                                              ...
                                              chickenrecipeInstructions:
                                                  snapshot.data!.meals![index]
                                                      .strInstructions
                                                      .toString(),
                                              chickenrecipeIngredients1:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient1
                                                      .toString(),
                                              chickenrecipeIngredients2:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient2
                                                      .toString(),
                                              chickenrecipeIngredients3:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient3
                                                      .toString(),
                                              chickenrecipeIngredients4:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient4
                                                      .toString(),
                                              chickenrecipeIngredients5:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient5
                                                      .toString(),
                                              chickenrecipeIngredients6:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient6
                                                      .toString(),
                                              chickenrecipeIngredients7:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient7
                                                      .toString(),
                                              chickenrecipeIngredients8:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient8
                                                      .toString(),
                                              chickenrecipeIngredients9:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient9
                                                      .toString(),
                                              chickenrecipeIngredients10:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient10
                                                      .toString(),
                                              chickenrecipeIngredients11:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient11
                                                      .toString(),
                                              chickenrecipeIngredients12:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient12
                                                      .toString(),
                                              chickenrecipeIngredients13:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient13
                                                      .toString(),
                                              chickenrecipeIngredients14:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient14
                                                      .toString(),
                                              chickenrecipeIngredients15:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient15
                                                      .toString(),
                                              chickenrecipeIngredients16:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient16
                                                      .toString(),
                                              chickenrecipeIngredients17:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient17
                                                      .toString(),
                                              chickenrecipeIngredients18:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient18
                                                      .toString(),
                                              chickenrecipeIngredients19:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient19
                                                      .toString(),
                                              chickenrecipeIngredients20:
                                                  snapshot.data!.meals![index]
                                                      .strIngredient20
                                                      .toString(),
