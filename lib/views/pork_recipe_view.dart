...
import 'package:recipe_app/services/pork_recipe_provider.dart';
import 'package:recipe_app/views/beef_recipe_view.dart';

class PorkRecipeView extends StatefulWidget {
  const PorkRecipeView({super.key});

  @override
  State<PorkRecipeView> createState() => _PorkRecipeViewState();
}

class _PorkRecipeViewState extends State<PorkRecipeView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Expanded(
          child: FutureBuilder<PorkRecipesModel>(
              future: getPorkRecipes(),
